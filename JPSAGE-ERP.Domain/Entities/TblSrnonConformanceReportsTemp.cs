...
{
    public partial class TblSrnonConformanceReportsTemp
    {
        public TblSrnonConformanceReportsTemp()
        {
            TblSrncrattachmentsTemp = new HashSet<TblSrncrattachmentsTemp>();
        }
        ...
        public virtual ICollection<TblSrncrattachmentsTemp> TblSrncrattachmentsTemp { get; set; }
    }
}
